...
<head>
	...
	<link href="http://feeds.feedburner.com/" rel="alternate" title="Diffing a fresh rails 3 app against a rails 4 app" type="application/atom+xml">
	...
	<div class="unit-inner unit-article-inner">
		<div class="content">
			<header>
				<div class="unit-head">
					<div class="unit-inner unit-head-inner">
						<h1 class="h2 entry-title">Diffing a fresh rails 3 app against a rails 4 app</h1>
					</div><!-- unit-inner -->
				</div><!-- unit-head -->
			</header>
...
...some time later :)
					...
					<div class="meta">
						<p class="date-publish">
							Published: 
							<date class="date-pub" title="2013-07-26T00:00:00+02:00" datetime="2013-07-26T00:00:00+02:00" pubdate>
    	...
    	<li><a href="/tags.html#rails4-ref">rails4 <span>1</span></a></li>
				...
				<div class="unit-inner unit-foot-inner">
					<nav class="pagination">
						<ul>
							...
							<li class="next"><a class="internal" rel="next"  href="/2013/09/03/creating-and-publishing-a-newrelic-passenger-plugin" title="View Creating And Publishing A New Relic Passenger Plugin">Creating And Publishing A New Relic Passenger Plugin &raquo;</a></li>
...
<script>
	...
	// load('//connect.facebook.net/en_US/all.js#xfbml=1', 'fbjssdk'); // Checkout http://j.mp/wZw2xR for using open graph protorol html for this is <div class="fb-like" data-href="/2013/07/26/diff-rails3-rails4" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" data-font="verdana"></div>
	}(document, 'script'));
</script>
<script>
